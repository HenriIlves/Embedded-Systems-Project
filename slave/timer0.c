...
#define TCCRB0_CLOCK_SELECT_MASK (0b111)
...
void setup_timer0(void) {
    ...
    // Set WGM to clear on timer compare (CTC)
    ...
    // Set output compare register A to the value computed for 10 ms cycle
    OUTPUT_COMPARE_A = OCRA_PERIOD_10MS;

    // Set the bit matching the compare A match interrupt in the interrupt mask register (TIMSK)
